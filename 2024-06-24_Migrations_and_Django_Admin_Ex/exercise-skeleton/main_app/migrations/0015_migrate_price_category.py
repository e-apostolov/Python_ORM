...
def reverse_fulfilling_of_columns(apps, schema_editor):
    smartphone_model = apps.get_model('main_app', 'SmartPhone')

    for smartphone in smartphone_model.objects.all():
        smartphone.category = smartphone_model._meta.get_field('category').default
        smartphone.price = smartphone_model._meta.get_field('price').defautl
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_all_columns, reverse_fulfilling_of_columns)
    ]
